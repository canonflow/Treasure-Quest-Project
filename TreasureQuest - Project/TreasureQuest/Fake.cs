...
namespace TreasureQuest
{
    public partial class Fake : Form
    {
        ...
        // Label
        string text = "ARRGGGHHH... sial harta karun kosong ini membuat aku marah.\nAku tidak tahu kalau ada Pulau Levneel yang palsu. 😡😡😡";
        int cnt = 0;
        ...
        {
            _music = new SoundPlayer(@"Music/wav/Fake.wav");
            _music.PlayLooping();
        }
        #endregion
    }
